...
function Homeloan(){
   ...
   const styles = {
    ...
    formContainer: {
      backgroundColor: 'light green', // Green background
      borderRadius: '16px',
      padding: '32px',
      width: '100%',
      maxWidth: '640px',
    ...
    subHeading: {
      fontSize: '1.25rem',
      marginBottom: '32px',
      color: '#0D6DB7', // Light green color
    },
    form: {
      display: 'flex',
       ...
       <h2 style={styles.subHeading}>Please fill all the details to approve your loan</h2>
         ...
         {calculatedAmount !== null && (
           <div style={styles.resultContainer}>
             <p>Remaining Amount after Initial Deposit: {Number(formData.amount) - Number(formData.initialDeposit)} PKR</p>
